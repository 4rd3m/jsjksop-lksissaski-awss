...
local Library do 
    ...
    Library.ToRich = function(self, Text, Color)
        return StringFormat('<font color="rgb(%d, %d, %d)">%s</font>', MathFloor(Color.R * 255), MathFloor(Color.G * 255), MathFloor(Color.B * 255), Text)
    end
    ...
    Library.SetTheme = function(self, ThemeNameOrTable)
        local TargetTheme = type(ThemeNameOrTable) == "string" and self.Themes[ThemeNameOrTable] or ThemeNameOrTable
        if not TargetTheme then return end
        for Property, Color in pairs(TargetTheme) do
            self:ChangeTheme(Property, Color)
        end
    end
    ...
    Components.Keybind = function(Data)
        ...
        local Items = { } do
            Items["KeyButton"] = Instances:Create("TextButton", {
                ...
                BorderSizePixel = 1,
                TextSize = 12,
                BackgroundColor3 = FromRGB(58, 66, 77)
            })  Items["KeyButton"]:AddToTheme({TextColor3 = "Text", BackgroundColor3 = "Element", BorderColor3 = "Outline"})
