...
local Library do 
    ...
    local Themes = {
        ["Default"] = {
            ["Window Background"] = FromRGB(20, 15, 25),
            ["Inline"] = FromRGB(12, 8, 15),
            ["Text"] = FromRGB(220, 220, 220),
            ["Section Background"] = FromRGB(15, 10, 20),
            ["Element"] = FromRGB(35, 25, 45),
            ["Border"] = FromRGB(50, 35, 65),
            ["Outline"] = FromRGB(0, 0, 0),
            ["Dark Liner"] = FromRGB(30, 20, 40),
            ["Risky"] = FromRGB(255, 50, 50),
            ["Accent"] = FromRGB(102, 51, 153)
        },
